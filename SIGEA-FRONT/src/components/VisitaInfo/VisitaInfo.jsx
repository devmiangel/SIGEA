...
const iconoTipo = `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#3e9a8a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.83z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>`
const iconoPin = `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#3e9a8a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>`
const iconoDocumento = `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#3e9a8a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>`
                ...
                <div class="vt-card">
                    <div style="display:flex; align-items:center; gap:14px; padding-bottom:14px; border-bottom:2px solid #eef1f4;">
                        ...
                        <div style="min-width:0;">
                            <h2 style="margin:0;font-size:17px;font-weight:600;color:#1f2937;line-height:1.3;">${nombreSolicitante || 'Productor'} <span style="color:#3e9a8a;">·</span> ${tipoVisita}</h2>
                    ...
                    <div style="display:flex; gap:12px; padding:14px 0;">
                        ...
                        <div class="vt-tile">
                            ...
                            <p class="vt-value">${visita.Ubicacion ?? '—'}</p>
                        </div>
                    </div>
                    ...
                    <div style="background:#f8fafc; border:1px solid #eef1f4; border-radius:10px; padding:12px 14px;">
                        ...
                        <p style="margin:0; font-size:13.5px; color:#374151; line-height:1.6;">${solicitud.observacion ?? 'Sin descripción'}</p>
                    </div>
