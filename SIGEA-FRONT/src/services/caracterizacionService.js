...
export const getRazasPorGrupo = (grupoId) => getCatalogo(`/UPs/gruposAnimales/${grupoId}/razas/`)
...
export const crearRaza = (nombre, grupoId) => crearCatalogo('/UPs/razas/', { Raza: nombre, grupoId })
